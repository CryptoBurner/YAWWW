...
PASS <- new.env()
assign("apikey","9dba4dd7-c205-4828-a0b9-9e1fb504701c",envir = PASS)
...
tmp2 = getLatestQuote(symbol = "SOL", fiat = "CAD")
...
tmp <- cryptoConversionRate(amount=1, fromSymbol = "SOL", toSymbol = "USD")
tmp <- cryptoConversionRate(amount=1, fromSymbol = "YAW", toSymbol = "USD")
